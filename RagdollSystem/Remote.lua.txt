-- Create a folder under ReplicatedStorage and call it "Remotes" then create a remote instance called "GettingUp"

-- Must be a ServerScript and placed under serverscriptservice
